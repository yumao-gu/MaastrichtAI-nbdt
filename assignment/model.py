...
from assignment.models.utils import load_state_dict_from_key, coerce_state_dict
from assignment.data.custom import Node, dataset_to_dummy_classes
from assignment.graph import get_root, get_wnids, synset_to_name, wnid_to_name
import torch
import torch.nn as nn
...
class EmbeddedDecisionRules(nn.Module):
    ...
    def get_node_logits(outputs, node):
        ...
        """
        # print("begin get_node_logits")
        # print("num_classes")
        # print(node.num_classes)
        # print("new_to_old_classes")
        # print(node.new_to_old_classes)
        # for label in range(node.num_classes):
        #     print("label")
        #     print(label)
        #     print("outputs.T")
        #     print(outputs.T)
        #     print("outputs.T[node.new_to_old_classes[new_label]]")
        #     print(outputs.T[node.new_to_old_classes[label]])
        #     print("outputs.T[node.new_to_old_classes[new_label]].mean(dim=0)")
    ...
    def get_all_node_outputs(cls, outputs, nodes):
        ...
        for node in nodes:
            ...
            # print(node_logits)
            # print("preds")
            # print(wnid_to_outputs[node.wnid]['preds'])
            # print("probs")
            # print(wnid_to_outputs[node.wnid]['probs'])
...
class SoftEmbeddedDecisionRules(EmbeddedDecisionRules):
    ...
    def traverse_tree(cls, wnid_to_outputs, nodes):
        ...
        """
        # print("begin Soft traverse_tree")
        # print("wnid_to_outputs")
        # print(wnid_to_outputs)
        example = wnid_to_outputs[nodes[0].wnid]
        ...
        # print("class_probs")
        # print(class_probs)
        # print("end Soft traverse_tree")
        return class_probs

    def forward_with_decisions(self, outputs):
        # print("begin Soft forward_with_decisions")
        ...
        for index, prediction in enumerate(predicted):
            ...
            decisions.append(decision)
        # print("end Soft forward_with_decisions")
